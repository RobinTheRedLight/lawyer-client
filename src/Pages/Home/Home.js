...
const Home = () => {
    ...
    return (
        <div>
            ...
            <div className='p-5'>
                <h1 className='border-2 border-white rounded-lg text-4xl font-semibold font-mono p-2'>Service Added</h1>
            </div>
            {
                serviceData.length !== 0 ?
                                    ...
                                    <div className='py-2' key={data._id}>
                                        <div className='border-2 border-white rounded-lg'>
                                            <div className="card  bg-base-100 shadow-xl">
                                                    ...
                                                    <PhotoProvider>
                                                        <div className="foo">
                                                            <PhotoView src={data.image}>
                                                                <img src={data.image} alt="" className="rounded-xl w-40" />
                                                            </PhotoView>
                                                        </div>
                                                    </PhotoProvider>
                                                ...
                                                <div className="card-body items-center text-justify pb-3">
                                                    <div className='grid  grid-cols-5 gap-3'>
                                                        <h2 className="font-mono card-title col-span-3">{data.serviceName}</h2>
                                                        <p className='font-mono col-span-2'>(Fee: {data.price})</p>
                                                    </div>
                    ...
                    :
                    <h1 className='text-4xl font-semibold font-mono pt-5'>No Service Added</h1>
            }
        </div>
    );
};
